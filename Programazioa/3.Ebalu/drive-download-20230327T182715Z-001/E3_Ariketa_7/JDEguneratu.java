...
public class JDEguneratu extends JDialog {
   ...
   public JDEguneratu (HasieraGUI hGUI){
      ...
      this.eguneratu = new JButton("Eguneratu");
      this.jp = new JPanel();
      this.db = new DB();
      ...
      this.jp.add(eguneratu);
 
      this.add(jp);
      
      this.eguneratu.addActionListener(e -> eguneratu());
