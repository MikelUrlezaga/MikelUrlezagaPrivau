...
UPDATE IKASTAROAK SET IRAKASLE_KODEA=4 WHERE KODEA=1;
UPDATE IKASTAROAK SET IRAKASLE_KODEA=2 WHERE KODEA=2;
UPDATE IKASTAROAK SET IRAKASLE_KODEA=2 WHERE KODEA=3;
UPDATE IKASTAROAK SET IRAKASLE_KODEA=1 WHERE KODEA=4;
UPDATE IKASTAROAK SET IRAKASLE_KODEA=1 WHERE KODEA=5;
UPDATE IKASTAROAK SET IRAKASLE_KODEA=3 WHERE KODEA=6;
